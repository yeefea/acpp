...
void demo_array()
{
    ...
    *(coords + 1) = 2.3;
    ...
    describe_array(month_lengths, sizeof(month_lengths) / sizeof(month_lengths[0]));
}
...
void demo_const_ptr()
{
    ...
    *cptr = 3; // ok, cptr itsenf is a contant, but the value it refers to is a variable and can be changed.
